...
ASGI_APPLICATION = "dotfm.asgi.application"
...
SECRET_KEY = env.str("SECRET_KEY", default="django-insecure-OyRKAW5zv4Jz3BQct3UzSBLqoGM7KE4QdcP4tnsc2hQ")
