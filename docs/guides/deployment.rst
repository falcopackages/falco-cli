...
Gunicorn can be configured using a Python file, such as `this one <https://github.com/Tobi-De/falco/blob/main/src/falco_blueprints/project_name/deploy/gunicorn.conf.py>`_ provided with a generated Falco project. 
