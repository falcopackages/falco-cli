...
Contributions to the guides should be made via `GitHub Discussions <https://github.com/falcopackages/falco-cli/discussions>`_. Any
...
Report bugs at https://github.com/falcopackages/falco-cli/issues.
...
The best way to send feedback is to file an issue at https://github.com/falcopackages/falco-cli/issues.
...
1. Fork the `falco-cli` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/falco-cli.git --recurse-submodules
...
5. Install pre-commit hooks for linting and code formatting before every commit::
...
3. The pull request should work for Python 3.13 and 3.14. Check
   https://github.com/falcopackages/falco-cli/pulls
